...
class AIService {
  static const String baseUrl = "http://192.168.1.7:5000"; // <-- change for real device

  /// Predicts remaining-month consumption and bill using live appliance
  /// states + actual units used so far (read server-side from Firebase
  /// when available; these params are the fallback if Firebase Admin
  /// is unreachable).
  static Future<Map<String, dynamic>> getPrediction({
    int occupancy         = 1,
    int numOccupants       = 3,
    double unitsUsedSoFar  = 0.0,
    int fanState    = 1,
    int fridgeState = 1,
    int acState     = 0,
    int lightState  = 1,
  ...
  /// Checks whether a specific appliance's current reading is anomalous.
  ...
  /// Gets rule-based AI suggestions from model outputs.
